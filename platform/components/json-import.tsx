...
import { coloringAtom, graphAdjacencyListAtom, kColorsAtom, vertexGraphAtom, edgeGraphAtom, vertexGraphType, stylePropsAtom, edgeGraphType, graphAdjacencyListType } from "@/lib/atoms";
...
export function JSONImport({upload}: {upload?: boolean}){
  ...
  const setK = useSetAtom(kColorsAtom);
